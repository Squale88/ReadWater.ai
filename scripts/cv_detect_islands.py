...
Output: data/areas/rookery_bay_v2/images/structures/<cell>/cv_islands_<ts>.{png,json}
...
def run_one(cell_id: str) -> int:
    ...
    overlay_path = out_dir / f"cv_islands_{ts}.png"
    json_path = out_dir / f"cv_islands_{ts}.json"
