...
Output: data/areas/rookery_bay_v2/images/structures/<cell>/cv_points_<ts>.{png,json}
...
def run_one(cell_id: str) -> int:
    ...
    overlay_path = out_dir / f"cv_points_{ts}.png"
    json_path = out_dir / f"cv_points_{ts}.json"
